                            ...
                            >
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        backgroundColor: (event.media?.url || event.image) ? 'transparent' : 'var(--primary, #3c81b5)',
                                        overflow: 'hidden',
                                    }}>
                                        {(event.media?.url || event.image) ? (
                                            <Image
                                                src={event.media?.url || event.image}
                                                alt={event.venue || event.title || "Etkinlik"}
                                                fill
                                                style={{
                                                    objectFit: 'cover',
                                                }}
                                        ...
                                        {(event.event_date || event.date) && (
                                            <div style={{
                                                ...
                                                <div style={{
                                                    ...
                                                    {(event.venue || event.eventName) && (
                                                        <div
                                                            style={{ fontWeight: 'bold' }}
                                                            dangerouslySetInnerHTML={{ __html: event.venue || event.eventName }}
                                                        />
                                                    )}
                                                </div>
                                            </div>
