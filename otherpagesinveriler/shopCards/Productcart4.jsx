    ...
    <div className="card-product style-4 fl-item" key={product.id}>
      <div className="card-product-wrapper">
        ...
        <div className="list-product-btn column-right">
          <a onClick={() => addToWishlist(product.id)} className="box-icon bg_white wishlist btn-icon-action round">
            <span className={`icon icon-heart ${isAddedtoWishlist(product.id) ? "added" : ""}`}></span>
          ...
          >
            <span className={`icon icon-compare ${isAddedtoCompareItem(product.id) ? "added" : ""}`}></span>
